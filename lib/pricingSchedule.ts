...
export type TicketTierId = 'participant' | 'all-access' | 'online';
...
export const TICKET_CARD_ORDER: ReadonlyArray<TicketTierId> = ['participant', 'all-access', 'online'];
...
const PRICING_PHASES: ReadonlyArray<PricingPhase> = [
	{
		...
		endDate: '2026-08-15',
		prices: { participant: 2990, 'all-access': 4990, online: 890 },
	},
	{
		id: 'early-birds',
		phase: 'Early Birds',
		...
		endDate: '2026-09-15',
		prices: { participant: 3390, 'all-access': 5590, online: 990 },
	},
	{
		id: 'first-price',
		phase: 'First Price',
		...
		endDate: '2026-10-31',
		prices: { participant: 3790, 'all-access': 6490, online: 1190 },
	},
	{
		id: 'main-price',
		phase: 'Main Price',
		...
		endDate: '2027-01-17',
		prices: { participant: 4190, 'all-access': 7290, online: 1290 },
	},
	{
		id: 'lazy-owls',
		phase: 'Lazy Owls',
		...
		endDate: '2027-02-14',
		prices: { participant: 4390, 'all-access': 7690, online: 1390 },
	},
	{
		id: 'last-chance',
		phase: 'Last Chance',
	...
	},
	{
		...
		endDate: '2027-02-25',
		prices: { participant: 5190, 'all-access': 8590, online: 1590 },
	},
];
